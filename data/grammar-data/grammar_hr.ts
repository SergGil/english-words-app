...
export const GRAMMAR_HR: GrammarCategory[] = [
    ...
    "rules": [
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Кожне хорватське дієслово має вид: несвершений (тривала або повторювана дія) або свершений (одноразова, завершена дія з результатом). Це не залежить напряму від часу.",
            "en": {
              "text": "Every Croatian verb has an aspect: imperfective (ongoing/repeated action) or perfective (a single completed action with a result). This is independent of tense."
            }
          },
          {
            "type": "table",
          ...
          },
          {
            ...
            "rows": [
              [
                "Čitao sam knjigu cijelo popodne.",
                "Я читав книгу весь день (процес)."
              ],
              [
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Свершений вид найчастіше утворюється додаванням префікса до несвершеного дієслова, а вторинний несвершений — інфіксами -ava-/-iva-/-a-.",
            "en": {
              "text": "The perfective aspect is most often formed by adding a prefix to the imperfective verb, and a secondary imperfective by the infixes -ava-/-iva-/-a-."
            }
          },
          {
            "type": "table",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Перфект — основний і найуживаніший минулий час, утворюється з допоміжного дієслова \"biti\" в теперішньому часі та дієприкметника минулого часу на -o/-la/-lo/-li/-le, який узгоджується з підметом у роді й числі.",
            "en": {
              "text": "The perfect tense is the main, most commonly used past tense, formed with the present tense of \"biti\" plus the l-participle (-o/-la/-lo/-li/-le), which agrees with the subject in gender and number."
            }
          },
          {
            "type": "formula",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Аорист — літературний, розповідний минулий час, що утворюється переважно від свершених дієслів. У сучасній розмовній мові вживається рідко, здебільшого в літературі та фольклорі.",
            "en": {
              "text": "The aorist is a literary, narrative past tense formed mainly from perfective verbs. In modern spoken language it's rare, used mostly in literature and folklore."
            }
          },
          {
            "type": "formula",
          ...
          },
          {
            ...
            "rows": [
              [
                "\"Dođoh, vidjeh, pobijedih\" — čuvena izreka.",
                "\"Прийшов, побачив, переміг\" — відомий вислів."
              ],
              [
                "Odoh kući.",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Імперфект описує тривалу дію в минулому й утворюється переважно від несвершених дієслів. Як і аорист, у сучасній розмовній мові майже не використовується — заміняється перфектом.",
            "en": {
              "text": "The imperfect describes an ongoing past action and is formed mainly from imperfective verbs. Like the aorist, it's almost never used in modern spoken language — replaced by the perfect."
            }
          },
          {
            "type": "formula",
      ...
      },
      {
        ...
        "sections": [
          ...
          },
          {
            ...
            "rows": [
              [
                "Već sam bio pojeo kad si stigao.",
      ...
      },
      {
        ...
        "sections": [
          ...
          },
          {
            ...
            "rows": [
              [
                "Kad budem završio posao, zovem te.",
    ...
    "rules": [
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Давальний відмінок (dativ) відповідає на питання \"кому? чому?\" і позначає одержувача дії — того, кому щось дають, кажуть чи допомагають.",
            "en": {
          ...
          },
          {
            ...
            "rows": [
              ...
              [
                "stol (стіл, нежив.)",
                "stol",
                "Vidim stol. (Я бачу стіл.)"
              ],
              [
                "kava (кава)",
                "kavu",
                "Pijem kavu. (Я п'ю каву.)"
              ]
            ]
          },
          {
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Родовий відмінок множини — одна зі складніших форм: у жіночому та середньому роді часто вставляється голосний -a- між приголосними основи, у чоловічому додається -a або нульове закінчення.",
            "en": {
              "text": "The genitive plural is one of the trickier forms: feminine and neuter nouns often insert a vowel -a- between stem consonants, while masculine nouns add -a or take a zero ending."
            }
          },
          {
            "type": "table",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Хорватські прикметники мають означену форму (для конкретного, відомого предмета) і неозначену (для будь-якого предмета цього типу) — щось на кшталт артикля, вбудованого в саме закінчення прикметника.",
            "en": {
              "text": "Croatian adjectives have a definite form (for a specific, known object) and an indefinite form (for any object of that type) — functioning somewhat like an article built into the adjective ending."
            }
          },
          {
            "type": "table",
      ...
      },
      {
        ...
        "title": "Sklonidba osobnih zamjenica — A2",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Короткі (клітичні) форми — займенники, допоміжне \"biti\" (sam, si, je...), частка \"li\" — завжди стоять на другій позиції в реченні, одразу після першого наголошеного слова чи групи слів, незалежно від того, що це слово.",
            "en": {
              "text": "Short (clitic) forms — pronouns, the auxiliary \"biti\" (sam, si, je...), the particle \"li\" — always occupy the second position in the clause, right after the first stressed word or phrase, regardless of what that word is."
            }
          },
          {
            "type": "table",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "У хорватській для належності людині часто вживають присвійний прикметник, утворений від власного імені чи іменника суфіксом -ov/-ev/-in, а не родовий відмінок.",
            "en": {
              "text": "In Croatian, possession by a person is often expressed with a possessive adjective formed from the name or noun with the suffix -ov/-ev/-in, rather than the genitive case."
            }
          },
          {
            "type": "table",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Хорватська має триступеневу систему вказівних займенників за відстанню від мовця: ovaj (близько до мовця), taj (близько до співрозмовника), onaj (далеко від обох).",
            "en": {
              "text": "Croatian has a three-way demonstrative system based on distance from the speaker: ovaj (near the speaker), taj (near the listener), onaj (far from both)."
            }
          },
          {
            "type": "table",
          ...
          },
          {
            ...
            "rows": [
              ...
              [
                "Onaj čovjek tamo je moj susjed.",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Питальні займенники \"tko\" (хто) і \"što\" (що) відмінюються за відмінками так само, як іменники, на які вони вказують.",
            "en": {
              "text": "The interrogative pronouns \"tko\" (who) and \"što\" (what) decline by case, like the nouns they stand for."
            }
          },
          {
            "type": "table",
            "title": "\"tko\" за відмінками",
            "rows": [
              [
                "Nominativ",
                "tko?",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Дієслово \"imati\" (мати) у запереченні зливається в одне слово \"nemati\", і об'єкт при цьому найчастіше залишається в знахідному відмінку (на відміну від деяких інших слов'янських мов, де перехід до родового суворіший).",
            "en": {
              "text": "The verb \"imati\" (to have) fuses with negation into \"nemati\", and the object most often stays in the accusative (unlike some other Slavic languages, where the shift to genitive is stricter)."
            }
          },
          {
            "type": "formula",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Хорватський порядок слів гнучкий, оскільки відмінки показують граматичну роль слова незалежно від позиції. Базовий порядок SVO, але зміна порядку слів зазвичай змінює наголос/фокус речення.",
            "en": {
              "text": "Croatian word order is flexible because case endings mark grammatical role regardless of position. The basic order is SVO, but changing word order usually shifts emphasis or focus."
            }
          },
          {
            "type": "table",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "У хорватській, особливо після дієслів бажання/можливості, часто вживають конструкцію \"da\" + дієслово в теперішньому часі замість інфінітива, надто коли підмети головного й підрядного дієслова різні.",
            "en": {
              "text": "In Croatian, especially after verbs of wanting/ability, the construction \"da\" + present tense is often used instead of the infinitive — especially when the subjects of the main and subordinate verb differ."
            }
          },
          {
            "type": "table",
      ...
      },
      {
        ...
        "sections": [
          ...
          },
          {
            ...
            "rows": [
              [
                "Danas je peti svibnja.",
                "Сьогодні п'яте травня."
              ],
              [
                "Rođen sam u prosincu.",
      ...
      },
      {
        ...
        "sections": [
          {
            "type": "intro",
            "text": "Щоб запитати час, кажуть \"Koliko je sati?\", а відповідь уживає порядковий числівник у жіночому роді, оскільки \"sat\" (година) мислиться разом із родовим означеної години.",
            "en": {
              "text": "To ask the time, Croatians say \"Koliko je sati?\", and the answer uses the feminine ordinal since the hour concept is treated in the feminine."
            }
          },
          {
            "type": "table",
        ...
        "sections": [
          {
            ...
            "en": {
              "text": "For informal address, Croatian uses \"ti\" (2nd person singular); for polite/formal address it uses \"Vi\" (2nd person plural, capitalized), even to a single person."
            }
          },
          {
            "type": "table",
  ...
  },
  {
    ...
    "rules": [
        ...
        "sections": [
          ...
          },
          {
            ...
            "rows": [
              ...
              [
                "Idem u trgovinu, hoćeš li nešto?",
      ...
      {
        "id": "jat-reflex-spelling",
        "title": "Jat: ije/je/e (ijekavica) — B1",
        "titleEn": "Jat Reflex Spelling: ije/je/e — B1",
        "emoji": "✍️",
        "sections": [
          {
            "type": "intro",
            "text": "Стандартна хорватська мова — ієкавська: старослов'янський звук \"ять\" (jat) відображається як ije, je або e залежно від довготи складу й слова. Написання варто запам'ятовувати індивідуально.",
            "en": {
              "text": "Standard Croatian is Ijekavian: the old Slavic vowel \"jat\" is reflected as ije, je, or e depending on syllable length and the word. Spelling has to be memorized word by word."
            }
          },
          {
            "type": "table",
            "title": "Приклади рефлексів jat",
            "rows": [
              [
                "mlijeko",
                "молоко",
      ...
      {
        "id": "sibilant-alternations",
        "title": "Sibilarizacija i palatalizacija — B1",
        "titleEn": "Consonant Alternations (Sibilarization) — B1",
        "emoji": "🔃",
        "sections": [
          {
            "type": "intro",
            "text": "Перед деякими закінченнями приголосні k/g/h чергуються з c/z/s (сибіляризація) або з č/ž/š (палаталізація) — наприклад, у кличному відмінку чи в множині.",
            "en": {
              "text": "Before certain endings, the consonants k/g/h alternate with c/z/s (sibilarization) or č/ž/š (palatalization) — for example in the vocative or the plural."
            }
          },
          {
            "type": "table",
          ...
          },
          {
            ...
            "rows": [
              ...
              [
                "Dajem knjigu ruci.",
                "Я передаю книгу в руки (приклад чергування)."
              ]
            ]
          }
        ]
